...
export const PALETTES: Palette[] = [
  { id: "okay", label: "Okay", hint: "fine, actually — just here", description: "Ori keeps it light and follows whatever has your attention.", accent: "#f0876a", accent2: "#ffb59a", mid: "#ef7a5a", deep: "#d9634a", cool: "#7fd0e0", onAccent: "#1a0d09", bg: "#07080b", bg2: "#0d0f15" },
  { id: "hopeful", label: "Hopeful", hint: "something's lifting", description: "Ori asks what shifted and helps you keep hold of it.", accent: "#4fb37f", accent2: "#a3ecc2", mid: "#3f9c6c", deep: "#2a6a49", cool: "#ffd08a", onAccent: "#04140b", bg: "#050806", bg2: "#0a120d" },
  { id: "heavy", label: "Heavy", hint: "low, flat, hard to move", description: "Ori slows down, stays close, and asks about the next hour instead of the next month.", accent: "#3fa7d6", accent2: "#8fd3ff", mid: "#2f8fc0", deep: "#1f5f86", cool: "#7fe0d0", onAccent: "#04121c", bg: "#05080d", bg2: "#0a1018" },
  { id: "lonely", label: "Lonely", hint: "nobody to tell", description: "Ori listens, then points you back toward a real person by name.", accent: "#4fc3d6", accent2: "#a9eef5", mid: "#3aa9bd", deep: "#22707e", cool: "#ffb59a", onAccent: "#031416", bg: "#04090a", bg2: "#091416" },
  { id: "anxious", label: "Anxious", hint: "wired, braced, can't settle", description: "Ori helps you slow the breath first, then look at the evidence together.", accent: "#9b6bff", accent2: "#c9b3ff", mid: "#8557f0", deep: "#5a36b8", cool: "#ff8fd8", onAccent: "#120a2a", bg: "#07060d", bg2: "#0e0b18" },
  { id: "angry", label: "Angry", hint: "at someone, or everything", description: "Ori takes the anger seriously, and offers a way to bring the heat down when you want it.", accent: "#e0332e", accent2: "#ff6b63", mid: "#c9221f", deep: "#8a1512", cool: "#ff9a8a", onAccent: "#ffffff", bg: "#040404", bg2: "#0c0708" },
  { id: "restless", label: "Restless", hint: "need to do something, unsure what", description: "Ori helps you find the nearest small thing you've been avoiding.", accent: "#e2a63a", accent2: "#ffd27a", mid: "#cf9230", deep: "#8f6320", cool: "#9fd6ff", onAccent: "#1a1204", bg: "#080704", bg2: "#12100a" },
  { id: "numb", label: "Numb", hint: "not much of anything", description: "Ori doesn't push for feeling; it asks about the body, the day, and what's near.", accent: "#9aa0ad", accent2: "#d5d9e2", mid: "#7f8694", deep: "#4c515c", cool: "#9fd6ff", onAccent: "#0b0c10", bg: "#060708", bg2: "#0e1013" },
];
