...
export const PALETTES: Palette[] = [
  ...
  { id: "angry", label: "Angry", hint: "at someone, or everything", description: "Ori takes the anger seriously, and offers a way to bring the heat down when you want it.", accent: "#dd312c", accent2: "#ff6b63", mid: "#c9221f", deep: "#8a1512", cool: "#ff9a8a", onAccent: "#ffffff", bg: "#040404", bg2: "#0c0708" },
